        ...
        <form action="{{ route('salaries.store') }}" method="POST">
            ...
            <table class="w-full form-table">
                ...
                <tr>
                    ...
                    {{-- Nama Karyawan diganti menjadi ID Karyawan (karyawan_id) sesuai Controller --}}
                    <td class="py-2"><input type="number" id="karyawan_id" name="karyawan_id" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"></td>
                </tr>
                <tr>
                    <td class="py-2"><label for="bulan" class="block text-sm font-medium text-gray-700">Bulan Gaji:</label></td>
                    {{-- Field Bulan ditambahkan karena ada di Controller Update dan Model --}}
                ...
                <tr>
                    ...
                    {{-- Nama field diganti menjadi gaji_pokok --}}
                ...
                <tr>
                    ...
                    {{-- Nama field diganti menjadi tunjangan --}}
                ...
                <tr>
                    ...
                    {{-- Nama field diganti menjadi potongan --}}
                 ...
                 <tr>
                    ...
                    {{-- Field Total Gaji ditambahkan karena ada di Controller dan Model --}}
